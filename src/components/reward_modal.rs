...
pub fn RewardModal() -> Element {
    ...
    let tier = use_signal(|| GlobalRewardTier::Low);
                    ...
                    div {
                        ...
                        div {
                            ...
                            button {
                                ...
                                style: format_tier_button(GlobalRewardTier::Low, tier.read(), "#4ade80"),
                                "Low"
                            }
                            button {
                                type: "button",
                                onclick: move |_| tier.set(GlobalRewardTier::Medium),
                                style: format_tier_button(GlobalRewardTier::Medium, tier.read(), "#c084fc"),
                                "Medium"
                            }
                            button {
                                type: "button",
                                onclick: move |_| tier.set(GlobalRewardTier::Jackpot),
                                style: format_tier_button(GlobalRewardTier::Jackpot, tier.read(), "#fb923c"),
                                "Jackpot"
                            }
                        }
                    },

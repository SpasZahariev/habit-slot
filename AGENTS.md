...
Issues live in [SpasZahariev/habit-slot](https://github.com/SpasZahariev/habit-slot) GitHub Issues, operated via the `gh` CLI. See `docs/agents/issue-tracker.md`.
